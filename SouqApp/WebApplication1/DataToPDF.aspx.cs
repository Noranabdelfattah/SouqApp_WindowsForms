...
{
    public partial class DataToPDF : System.Web.UI.Page
    {
        ...
        var collection2 = newuser.GetProducts();
            if (!IsPostBack)
            {
                ...
                GridView1.DataSource = collection2.ToList();
                GridView1.DataBind();
            }
        }
        ...
        protected void btnExportToPdf_Click(object sender, EventArgs e)
        {
            ...
            Response.AppendHeader("content-disposition","attachment;filename=Products.pdf");
